...
export const FormSelectStyle: StylesConfig = {
    control: (styles, {isFocused}) => ({...styles, backgroundColor: 'white', width: '280px',outline: `${isFocused && 'none !important'}`, border: `${isFocused ? '2px solid #3373B1' : '2px solid #d0d5dd'}`, boxShadow: '0px 1px 2px rgba(16, 24, 40, 0.05)', '&:hover': {border: `${isFocused && '2px solid #3373B1'}`}, borderRadius: '8px'}),
    option: (styles, {isSelected}) => {
